...
(function() {
    ...
    B.prototype.RayCast = function(b, e) {
        var f = -Number.MAX_VALUE,
            ...
            P = J = 0;
        P = 0;
        if (Math.abs(v) < Number.MIN_VALUE) { if (r < this.lowerBound.x || this.upperBound.x < r) return false } else {
            J = 1 / v;
    ...
    D.prototype.UpdatePairs = function(b) {
        ...
        for (f = e.m_moveBuffer.length = 0; f < e.m_pairCount;) {
            ...
            b(s, v);
            for (++f; f < e.m_pairCount;) { s = e.m_pairBuffer[f]; if (s.proxyA != r.proxyA || s.proxyB != r.proxyB) break;++f }
        }
    };
...
(function() {
    ...
    G.prototype.ComputeSubmergedArea = function(k, z, u, D) {
        ...
        if (H > this.m_radius) { D.SetV(u); return Math.PI * this.m_radius * this.m_radius }
    ...
    A.prototype.RayCast = function(k, z, u) {
        ...
        for (var Z = parseInt(-1), d = 0; d < this.m_vertexCount; ++d) {
            ...
            E = N.x * z + N.y * R;
            if (E ==
                0) { if (O < 0) return false } else if (E < 0 && O < D * E) {
                D = O / E;
                Z = d
...
(function() {
    ...
    h.prototype.RayCastAll = function(a, c) {
        var g = new Vector;
        this.RayCast(function(b) { g[g.length] = b; return 1 }, a, c);
        return g
    };
